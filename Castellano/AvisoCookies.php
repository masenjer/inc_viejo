...
function createMessage(){
	...
	if(!getCookieMsg('messageCookie'+window.location.hostname)){
		...
		divMessage += '<p class="textCookie">Esta web utiliza <em>cookies</em> propias para ofrecerte una mejor experiencia y servicio. Al continuar con la navegaci&oacute;n entendemos que se acepta nuestra <a class="texto_normal" target="_blank" href="http://uab.cat/doc/Politiques-Cookies">pol&iacute;tica de cookies</a>.</p>';
		divMessage += "</div>";
		divMessage += "<div id='acceptCookie'>";
		divMessage += "<p id='buttonCookie' onclick='hideMessage()'>Cerrar</p>";
		divMessage += "</div>";
		divMessage += "</div>";
		divMessage += "</div>";
