...
<title>Instituto de Neurociencias (INc) - UAB Barcelona</title>
<meta name="description" content="Instituto de investigación que explora las cuestiones clave del cerebro de forma multidisciplinar y translacional con el objetivo de desarrollar nuevas terapias para el tratamiento de patologías cerebrales.">
...
<table width="928px" id="TableOmbres" cellpadding="0" cellspacing="0" border="0" align="center">
	...
	<tr>
    	...
    	<td style="border:1px solid #666;"><?php CarregaAplicacioDirectori(); ?></td>
