	...
	if ($_SESSION["Creacio"]=="1")
	{
		$resultado = $resultado . '<td align="right" width="42px">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td>
						<input type="text" style="width:20px; height:20px; vertical-align:middle;" id="OrdenCategoriaDirectori'.$row["IdDirectoriCategoria"].'" value="'.$row["Orden"].'"  onKeyPress="submitenter(13,event,'.$row["IdDirectoriCategoria"].')"><img id="ImageML" src="img/delete.jpg" onClick="MostraEliminaTOT(12,0,'.$row["IdDirectoriCategoria"].');" style="width:20px; height:20px; vertical-align:middle;"  ></td>
				</tr>
			</table>			
		</td>
	</tr>';
