...
<table width="100%" cellspacing="0" cellpadding="0" border="0"  style="border-style:solid;border-width:1px;border-color:#dddddd">
		...
		<td>
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr valign="top">
					...
					<td id="fuenteTitolML" align="left" valign="middle" height="35px" class="fuenteTitolML"> Categor&iacute;as </td>
					<td id="fuenteTitolML" width="5px" class="fuenteTitolML" ></td>
				</tr>
	...
	<tr valign="middle">
		...
		<td class="fuenteML" style="padding-top:10px; text-align:left;" height="25px">
			<a href = "Directori.php" style="text-decoration:none;" class="fuenteML"><div style="text-decoration:none;">Todos los registros</div></a>
		</td>
		<td width="5px"></td>
	</tr>';
