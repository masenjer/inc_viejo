    ...
    <script src="JQuery/jquery.selection.js" type="text/javascript"> </script>
	<?php include "JSAdmin.php"; ?>
    <script src="JS/Clases/Pestanyas.js" type="text/javascript"> </script>

    <script src="JS/p.js" type="text/javascript"> </script>
    <script src="JS/funcions.js" type="text/javascript"> </script>
    <script src="JS/ColorWeb.js" type="text/javascript"> </script>
    ...
    <script src="JS/PaginesOcultes.js" type="text/javascript"> </script>
    <script src="JS/Directori.js" type="text/javascript"> </script>
    <script src="JS/DirectoriFitxa.js" type="text/javascript"> </script>
    <script src="JS/DirectoriCategories.js" type="text/javascript"> </script>
    <script src="JS/Publicacions.js" type="text/javascript"> </script>
