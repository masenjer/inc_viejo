...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
    	<td colspan="2" class="fuenteTitolContingut" style="padding-bottom:20px;">
        	En construcci&oacute;n, disculpad las molestias!
        </td>
    </tr>    
	<tr>
...
<table width="100%" cellpadding="0" cellspacing="0" class="RecuadreCercadorAuxiliar">
	<tr>
    	<td class="fuenteTitolContingut">Publicaciones:</td>
        <td class="fuenteContingut">Introduce el autor, t&iacute;tulo, a&ntilde;o i/o l&iacute;neas de investigaci&oacute;n para la b&uacute;squeda</td>
    </tr>
    <tr>
    ...
    <tr>
    	<td colspan="2" class="fuenteContingut">
        	<input type="radio" id="RadioCercaPublicacions" name="RadioCercaPublicacions" class="fuenteContingut" value="" onchange="PublicacionsCercador()" checked="checked" />Todos
        	<input type="radio" id="RadioCercaPublicacions0" name="RadioCercaPublicacions" class="fuenteContingut" value="0" onchange="PublicacionsCercador()" />Art&iacute;culos
        	<input type="radio" id="RadioCercaPublicacions1" name="RadioCercaPublicacions" class="fuenteContingut" value="1" onchange="PublicacionsCercador()" />Libros
        </td>
    </tr>
</table>
<?php
