			...
			?>
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td id="PestanyasDirectoriFitxa1" class="Pestanya" onclick="MuestraInvesDirectoriFitxa();">Investigación</td>
                        <td id="PestanyasDirectoriFitxa2" class="Pestanya" onclick="MuestraPubliDirectoriFitxa();">Publicaciones</td>
                    </tr>
                </table>
          	</td>
          	<td width="13px"></td> 
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="fuenteContingut">
		...
		<tr>
			<td style="padding-top:10px;"><span class="DadesFitxaDirectori"><b>Tel&eacute;fono</b></br>'.$row["Telefon"].'</span> </td>
		</tr>
		<tr>
			<td style="padding-top:10px;"><span class="DadesFitxaDirectori"><b>Direcci&oacute;n</b></br>'.$row["Adreca"].'</span> </td>
		</tr>
</table>';
