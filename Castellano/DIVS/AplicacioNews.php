...
?>
	<table width="100%" cellspacing="5" cellpadding="0" border="0" class="TextDossierNoticies">
    	<tr>
        	<td colspan="4"><span class="TitolTextDossierNoticies">Búsqueda por texto</span></td>
        </tr>
        <tr>
        	<td width="90px">Texto clave</td>
            <td colspan="3"><input id="SearchText" value="<?php echo $_SESSION["SearchText"]; ?>" type="text"></td>
        </tr>
    	<tr>
        	<td colspan="4" style="padding-top:10px;"><span class="TitolTextDossierNoticies">Búsqueda por fechas</span></td>
        </tr>
        <tr valign="bottom">
        	<td>Desde el día</td>
        	...
        	<td width="60px" align="right">Hasta el</td>
        ...
        <tr>
        	<td colspan="2" align="left"><button class="TextDossierNoticies" onClick="SearchAllNews(<?php echo $_GET["Noticia"]; ?>);">Mostrar todo</button></td>
        	<td colspan="2" align="right"><button class="TextDossierNoticies" onClick="SearchNews(<?php echo $_GET["Noticia"]; ?>);">Filtrar por búsqueda</button></td>
        </tr>
    </table>
<?php
}
