...
<table width="100%" height="23px" cellpadding="0" cellspacing="5" border="0">
	<tr> 
        ...
        <td width="20px"></td>
        <td class="APeca" align="left">CERCADOR<div id="ResultatCerca" style="position:fixed; width:300px; height:90%; overflow:auto; z-index:1000; display:none" align="left" ></div></td>
        <td width="5px"></td>
