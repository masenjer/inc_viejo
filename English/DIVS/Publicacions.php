...
<table width="100%" cellpadding="0" cellspacing="0" class="RecuadreCercadorAuxiliar">
	<tr>
    	<td class="fuenteTitolContingut">INc publications:</td>
        <td class="fuenteContingut" align="left">Insert Author/Title/Year/Research program to make the search</td>
    </tr>
    <tr>
    ...
    <tr>
    	<td colspan="2" class="fuenteContingut">
        	<input type="radio" id="RadioCercaPublicacions" name="RadioCercaPublicacions" class="fuenteContingut" value="" onchange="PublicacionsCercador()" checked="checked" />All
        	...
        	<input type="radio" id="RadioCercaPublicacions1" name="RadioCercaPublicacions" class="fuenteContingut" value="1" onchange="PublicacionsCercador()" />Books
        </td>
    </tr>
</table>
<?php
