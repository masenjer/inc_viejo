      	...
      	<tr>
			...
			?>
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td id="PestanyasDirectoriFitxa0" class="PestanyaSeleccionada" onclick="MuestraPerfilDirectoriFitxa();">Profile</td>
                        <td id="PestanyasDirectoriFitxa1" class="Pestanya" onclick="MuestraInvesDirectoriFitxa();">Research</td>
                        <td id="PestanyasDirectoriFitxa2" class="Pestanya" onclick="MuestraPubliDirectoriFitxa();">Publications</td>
                    </tr>
                </table>
          	</td>
          	<td width="13px"></td> 
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="fuenteContingut">
		...
		<tr>
			<td style="padding-top:10px;"><span class="DadesFitxaDirectori"><b>Telephone</b></br>'.$row["Telefon"].'</span> </td>
		</tr>
		<tr>
			<td style="padding-top:10px;"><span class="DadesFitxaDirectori"><b>Adress</b></br>'.$row["Adreca"].'</span> </td>
		</tr>
</table>';
