...
<div id="DIVHome">
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        -->             <td align="left" ><a href="https://www.facebook.com/INcuab" target="_blank"><img src="img/facebook.png" style="width:45px; border:none;" /></a></td>
                        ...
                        <td  align="center"><a href="https://ddd.uab.cat/collection/inc?ln=en" target="_blank"><img src="img/ddd_logo.jpg" style="height:45px; border:none;" /></a></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
        	<td colspan="2" style="padding-right:15px; padding-bottom:15px;">
            	<iframe src="//player.vimeo.com/video/119424549" width="402" height="226" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
            </td>
        </tr>
        <tr>
        	...
        	<table width="100%" cellpadding="0" cellspacing="0" border="0" style=" border-spacing:0px;" >
            	<tr>
                    ...
                    <td width="100%" bgcolor="#d7d5d6" style="border: 1px solid #d7d5d6;">
                    	<div style="width:100%;height:25px; background-image:url(img/CapcaRelleu2.png); padding-left:5px; text-align:right "><a href="News.php" class="fuenteTitolContingut" style="padding-right:30px;" title="All news">+ News</a></div></td>                                        
                </tr>
            </table>
        </td>
    </tr>
