...
?>
	<table width="100%" cellspacing="5" cellpadding="0" border="0" class="TextDossierNoticies">
    	<tr>
        	<td colspan="4"><span class="TitolTextDossierNoticies">Text search</span></td>
        </tr>
        <tr>
        	<td width="90px">Keywords</td>
            <td colspan="3"><input id="SearchText" value="<?php echo $_SESSION["SearchText"]; ?>" type="text"></td>
        </tr>
    	<tr>
        	<td colspan="4" style="padding-top:10px;"><span class="TitolTextDossierNoticies">Search by date</span></td>
        </tr>
        <tr valign="bottom">
        	<td>from date</td>
        	...
        	<td width="60px" align="right">To date</td>
        ...
        <tr>
        	<td colspan="2" align="left"><button class="TextDossierNoticies" onClick="SearchAllNews(<?php echo $_GET["Noticia"]; ?>);">Show all results</button></td>
        	<td colspan="2" align="right"><button class="TextDossierNoticies" onClick="SearchNews(<?php echo $_GET["Noticia"]; ?>);">Search results</button></td>
        </tr>
    </table>
<?php
}
