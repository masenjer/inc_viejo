...
function createMessage(){
	...
	if(!getCookieMsg('messageCookie'+window.location.hostname)){
		...
		divMessage += '<p class="textCookie">This web uses first-party cookies to provide you with a better experience and service. By continuing to use the site you agree to our <a class="texto_normal" target="_blank" href="http://uab.cat/doc/Politiques-Cookies">cookies policy</a>.</p>';
		divMessage += "</div>";
		divMessage += "<div id='acceptCookie'>";
		divMessage += "<p id='buttonCookie' onclick='hideMessage()'>Close</p>";
		divMessage += "</div>";
		divMessage += "</div>";
		divMessage += "</div>";
